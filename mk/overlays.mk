...
$(1)_ROUTED_SRCS = $$($(1)_GCC_272_CDK_G0_SRCS) $$($(1)_GCC_272_CDK_G0_NOSCHED_SRCS) $$($(1)_GCC_272_GNU_G0_SRCS) $$($(1)_GCC_280_G0_SRCS) $$($(1)_GCC_280_G4_SRCS) $$($(1)_GCC_280_G4_NOEXPAND_SRCS)
...
# The nosched subset shares the CDK G0 compile rule; it differs only by the
# target-specific -fno-schedule-insns flag applied below.
$(1)_GCC_272_CDK_G0_ALL_SRCS := $$($(1)_GCC_272_CDK_G0_SRCS) $$($(1)_GCC_272_CDK_G0_NOSCHED_SRCS)
...
# Disable the instruction scheduler for the nosched subset (target-specific var).
