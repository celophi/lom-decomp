...
# Rule: compile C files with GCC 2.8.0 G0 with builtins enabled + maspsx.
$$($(1)_GCC_280_G0_BUILTIN_OBJS): $(STAGING)/$$($(1)_BUILD_DIR)/$$($(1)_SRC_DIR)/%.o: $$($(1)_SRC_DIR)/%.c $(COPY_SENTINEL) | $(1)-validate
	@mkdir -p $$(@D)
	cd $(STAGING) && $(CC) $(CFLAGS_G0_BUILTIN) $(INCLUDE_FLAGS) -c $$($(1)_SRC_DIR)/$$*.c -S -o - | \
		$(MASPSX_AS) $(INCLUDE_FLAGS) $(MASPSX_FLAGS) -o $$($(1)_BUILD_DIR)/$$($(1)_SRC_DIR)/$$*.o
