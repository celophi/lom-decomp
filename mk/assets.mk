...
.PHONY: validate-assets validate-psx-tim-assets validate-sprite-layout-assets

validate-assets: validate-psx-tim-assets validate-sprite-layout-assets
...
$(COPY_SENTINEL): $(SPRITE_LAYOUT_BINARIES)
