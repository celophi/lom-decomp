...
void field_transform_effect_quad_vertices8(struct FieldMotionRecord* effect, struct FieldObjectRuntime* object, u8* quad_data, s32 vertex_index,
                                           Vec2s* screen_origin, SVECTOR* direction, VECTOR* gte_out);
void field_transform_effect_quad_vertices16(struct FieldMotionRecord* effect, struct FieldObjectRuntime* object, u8* quad_data, s32 vertex_index,
                                            Vec2s* screen_origin, SVECTOR* direction, VECTOR* gte_out);
