 ...
 * @c g_field_script[0]), and forwards the pair to func_8006AD04. When @c D_8010AE78
 ...
 *
 * @param arg0 Action index, or 0xFF to read the default from @c g_field_script[0].
