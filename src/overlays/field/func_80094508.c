 ...
 * @note GCC 2.7.2 CDK: 95.918365%, 96/98 exact instructions. The state load
 * and first comparison constant are scheduled earlier than in the target.
 */
void func_80094508(FieldActorState *arg0, s32 arg1, s32 arg2, s32 arg3)
{
    s32 temp_lo;
