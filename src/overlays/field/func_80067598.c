...
void field_update_actor_animations(s32);               /* extern */
 ...
 * @note WIP - not yet byte-matching. +10 insns; the D_800473F8 byte-read/
 *       word-write pair at the top is a guess. See
 *       working/field_build_frame_commands/STATUS.md.
 * @see decomp.me (84.51%) TODO
 */
void field_build_frame_commands(s32 arg0, s32 arg1)
{
    ...
    if ((D_800F2298 == 0) && (D_800F22C0 == 0) && (D_8012269C == 0) && (D_801227C8 == 0))
    {
        func_800B19FC();
    ...
    func_800A4798(arg0);
    func_80096B54();
    if ((D_800F2298 == 0) && (D_800F22C0 == 0) && (D_8012269C == 0) && (D_8011F3AC == 0) && (D_801227C8 == 0))
    {
        field_update_actor_animations(arg0);
    }
