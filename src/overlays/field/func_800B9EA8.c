...
void func_800B9EA8(void)
{
    ...
    CURRENT_SEQ_REC->unk8 = func_800BD204(b, (void *)CURRENT_SEQ_REC->unk8, &sp10);
    b >>= 2;
    CURRENT_SEQ_REC->unk8 = func_800BD204(b, (void *)CURRENT_SEQ_REC->unk8, &sp14);
    r = func_800BE5C8(b >> 2, sp10, sp14);
    CURRENT_SEQ_REC->unk8 = func_800BD2FC((u8 *)CURRENT_SEQ_REC->unk8, &sp18);
    func_800BD434(((SeqRec *)D_80123FB8)->unk0, sp18 << 16, r);
}
