 ...
 *
 * Resolves @p arg0 (0xFF reads the default from @c D_80123FB8[0]). When scene
 ...
 * 31 of the word at @c D_80123FB8[0].
 *
 * @param arg0 Channel index, or 0xFF to read the default from @c D_80123FB8[0].
...
void func_800BC4E8(s32 arg0, s32 arg1)
{
    ...
    *(s32 *)D_80123FB8 = *(s32 *)D_80123FB8 & 0x7FFFFFFF;
}
