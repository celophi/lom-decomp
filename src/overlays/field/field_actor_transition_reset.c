...
void field_battle_setup(s32 mode);
...
void field_update_battle_end(void)
{
    ...
    {
        if ((field_find_active_special_attack_actor() == 0) && (field_find_defeating_actor() == 0) && (g_field_text_session_active == 0) && (field_is_scene_fading() == 0) &&
