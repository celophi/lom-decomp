...
extern StateB9C30 *D_80123FB8;
void func_8009AFBC(s32 arg0);

/**
 * @brief Execute one 16-bit operand opcode from the active script entry.
 *
 * Resolves the active entry (state at @c D_80123FB8, index at 0x4, stride 0xC)
...
void func_800B9C30(void)
{
    ...
    idx = D_80123FB8->index;
    entry = (EntryB9C30 *)((u8 *)D_80123FB8 + idx * 0xC);
