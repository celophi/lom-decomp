...
void func_800B89D0(void)
{
    ...
    r = func_800BD3B0(((SeqRec *)g_field_script)->unk0, sp10 << 16);
    CURRENT_SEQ_REC->unk8 = field_script_read_operand(temp_s0, (void *)CURRENT_SEQ_REC->unk8, &sp14);
    CURRENT_SEQ_REC->unk8 = field_script_read_operand(temp_s0 >> 2, (void *)CURRENT_SEQ_REC->unk8, &sp18);
