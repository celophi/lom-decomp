 ...
 *
 * @see decomp.me (93.839874%) https://decomp.me/scratch/N2GNJ
    ...
    if (temp_t6 != NULL) {
        if (mover->collision_node == (void* )-1) {
            ...
            while (var_fp != NULL) {
                    ...
                    if ((((FieldCollisionNode*)var_fp)->unk18 != 0) && ((temp_v0 = (s32) ((FieldCollisionNode*)sp2C)->unk38 >> 8, var_v1 = ((FieldCollisionSurfaceDef*)temp_s6)->unk14 + (s16) temp_v0, (var_v1 == 0)) || (var_v1 < (var_s5 + mover->height_bias)) || (var_v1 < (s16) sp38))) {
                            ...
                            if (var_t8 != 0) {
                                ...
                                case 0:             /* switch 1 */
                                    if ((((FieldCollisionSurfaceDef*)temp_s6)->unk14 + (s16) temp_v0) < (s16) sp38) {
                                        if (var_a3 != 0) {
                                            temp_v1_4 = ((FieldCollisionSurfaceDef*)temp_s6)->unk10 + (s16) sp6C;
                                    ...
                                    break;
                                case 1:             /* switch 1 */
                                    if ((((FieldCollisionSurfaceDef*)temp_s6)->unk14 + (s16) sp6C) < (s16) sp38) {
...
return_zero:
    ...
    }
    {
        ...
        if (var_t9 != 0) {
            ...
            temp_v1_9 = temp_s0_3 + (u16) mover->mode_flags;
            if (((FieldCollisionHeaderBounds*)temp_a0_7)->unk2C & 2) {
                if ((temp_s0_3 < 0) || (temp_v1_9 >= ((FieldCollisionHeaderBounds*)temp_a0_7)->unk32)) {
                    var_s5 = func_8005E1A8(NULL, 0x7F, sp58, var_s5);
                }
                if ((temp_s1 < 0) || (temp_s2_3 >= ((FieldCollisionHeaderBounds*)sp28->header)->unk30)) {
            ...
            if (early_t7 != -1) {
                ...
                do {
                    ...
                    if (((((FieldCollisionNode*)var_fp)->unk1C + temp_a2_2) < sp6C) && (((((FieldCollisionNode*)var_fp)->unk1E + temp_a2_2) >= e_x_min))) {
                        ...
                        if (temp_a1_3 < sp70) {
                            temp_s1 = ((FieldCollisionNode*)var_fp)->unk20 + (s16) temp_a0_8;
                            if (temp_s1 >= sp74) {
                                var_s0 = temp_s1;
                                var_t1 = temp_a1_3;
                                if (sp78 < temp_s1) {
                    ...
                    if (((((FieldCollisionNode*)var_fp )->unk1C + node_x_offset) < f_x_max) && (((((FieldCollisionNode*)var_fp )->unk1E + node_x_offset) >= f_x_min))) {
                        ...
                        if (temp_a0_14 < f_y_max) {
                            ...
                            if (temp_v1_17 >= f_y_min) {
                                ...
                                var_s1_4 = (u8*)((FieldCollisionNode*)var_fp)->unk10 + (temp_lo_4 * 4);
                                f_x_max_2 = f_x_max;
        ...
        if (temp_v0_15 != -1) {
            ...
            do {
                ...
                if ((var_t0_2 >= temp_v1_24) && (((((FieldCollisionNode*)temp_t5_4)->unk20 + temp_a0_17) >= var_t0_2))) {
                    ...
                    var_s1_5 = (u8*)((FieldCollisionNode*)temp_t5_4)->unk10 + ((var_t0_2 - temp_v1_24) * temp_a0_18 * 4);
                    if ((s16) temp_a1_8 != 0) {
                        var_s0_10 = temp_a0_18 - 1;
                        if (temp_a0_18 != 0) {
                            do {
                                if (((s16) late_scan_x < (((FieldCollisionSpan*)var_s1_5)->min_x + (s16) temp_a1_8)) || ((((FieldCollisionSpan*)var_s1_5)->max_x + (s16) temp_a1_8) < (s16) late_scan_x)) {
                                    var_s1_5 += 4;
                                } else {
                                    goto g_hit;
                                }
                        ...
                        if (temp_a0_18 != 0) {
                            do {
                                if (((s16) late_scan_x < ((FieldCollisionSpan*)var_s1_5)->min_x) || (((FieldCollisionSpan*)var_s1_5)->max_x < (s16) late_scan_x)) {
                                    var_s1_5 += 4;
                                } else {
                                    goto g_hit;
                                }
            ...
            g_done:;
                ...
                case 1:                             /* switch 3 */
                    var_v1_4 = ((FieldCollisionSurfaceDef*)temp_s6)->unk14 + (s16) temp_v1_25;
                    if (var_v1_4 < var_t1) {
                        temp_s0_6 = func_8005DFAC((FieldCollisionNode*)sp2C, &probe.x);
                        if (var_t8 != 0) {
                        ...
                        if (var_a3 != 0) {
                            ...
                            if (var_s3 != NULL) {
                                if (var_s3 == sp2C) {
                                    temp_v0_18 = temp_s0_6 - ((FieldCollisionSurfaceDef*)((FieldCollisionNode*)sp2C)->unk4)->unk10;
                                    var_s2 += temp_v0_18;
                                    var_s4_3 += temp_v0_18 << 8;
                                } else {
                                    var_s2 = (temp_s0_6 + var_s2) - ((FieldCollisionSurfaceDef*)((FieldCollisionNode*)var_s3)->unk4)->unk10;
                                    var_s4_3 = var_s2 << 8;
                                    if (var_t8 != 0) {
                                        mover->collision_node = sp2C;
                                    }
...
s32 func_80060F58(FieldCollisionQuery *start_query, FieldCollisionQuery *goal_query, FieldCollisionPathPoint *output_path, s32 mode)
{
    ...
    if ((sp405C > 0) && (sp4060 > 0) && (sp4064 > 0) && (sp4068 > 0))
    {
        ...
        if ((sp405C < (s32) columns - 1) && (sp4060 < temp_v1_5) && (sp4064 < (s32) columns - 1))
        {
            if (sp4068 >= temp_v1_5)
            {
                return -2;
                ...
                *temp_s1 = 0xFB;
                ...
                if (func_80062820(&rec) == 0)
                {
                    ...
                    do
                    {
                        ...
                        temp_a0_14 = temp_s1[1];
                        temp_v1_34 = temp_a0_14 & 0xFF;
                        if (((u32) ((temp_a0_14 - 4) & 0xFF) < 0xF8U) && ((u32) (var_t0_2 & 0xFF) < temp_v1_34) && ((u32) (var_a3 & 0xFF) < temp_v1_34))
                        {
                            var_s0 = temp_s1 + 1;
                            var_t2 = 5;
                            var_a3 = temp_a0_14;
                        ...
                        if (((u32) ((temp_a0_15 - 4) & 0xFF) < 0xF8U) && ((u32) (var_t0_2 & 0xFF) < temp_v1_35) && ((u32) (var_a3 & 0xFF) < temp_v1_35))
                        {
                            var_s0 = temp_a2_3;
                            var_t2 = 2;
                            var_a3 = temp_a0_15;
                        ...
                        if (((u32) ((temp_a0_16 - 4) & 0xFF) < 0xF8U) && ((u32) (var_t0_2 & 0xFF) < temp_v1_36) && ((u32) (var_a3 & 0xFF) < temp_v1_36))
                        {
                            var_s0 = temp_a2_4;
                            var_t2 = 7;
                            var_a3 = temp_a0_16;
                        ...
                        temp_a0_18 = (temp_s1 - columns)[1];
                        var_v0_24 = temp_s1 + columns;
                        if (!(var_a1_3 & 0x12) || !(var_a3 & 0xFF))
                        {
                        ...
                        temp_a0_19 = (temp_s1 + columns)[-1];
                        var_v0_25 = temp_s1 + columns;
                        if (!(var_a1_3 & 0x48) || !(var_a3 & 0xFF))
                        {
                        ...
                        temp_a0_20 = (temp_s1 + columns)[1];
                        if (!(var_a1_3 & 0x50) || !(var_a3 & 0xFF))
                        {
                    ...
                    var_s4 = &path[2][1];
                    var_s3_3 = var_s7 - 2;
                    *var_fp = scene->unk2C + ((u16) scene->unk44 * sp4050) + (columns * sp4060) + sp405C;
                    var_fp = &path[0][0];
                    rec.stamp = 0;
                    path[1][0] = sp4074;
                    path[2][0] = sp4078;
                    ...
                    *var_s4 = sp4070;
                    ...
                    if (count != neg1)
                    {
                        do
                        {
                            ...
                            {
                                var_s3_4 = count;
                                rec.tile_base = temp_s1_3;
                                rec.start_x = temp_t9;
                                rec.start_z = temp_t8;
                                var_s0_2 = var_s3_4;
                                do
                                {
                                    temp_s2_2 = var_s0_2 + var_s6;
                                    temp_s1_4 = var_s0_2 + var_s4;
                                    rec.end_x = *temp_s2_2;
                                    rec.end_z = *temp_s1_4;
                                    if (func_80062820(&rec) != 0)
                                    {
