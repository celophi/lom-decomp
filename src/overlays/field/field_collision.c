 ...
 *
 * @note Matching remains incomplete. The target uses a 0x850-byte stack
 *       frame; this draft still has additional spills. Matching evidence is
