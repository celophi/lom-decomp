 ...
 *
 * @see decomp.me (93.05%, 1296/1586 exact) TODO
 */
                ...
                *temp_s1 = 0xFB;
                ...
                var_s4 = &path[2][0];
                        ...
                        if (sp407C != 0)
                        {
                            ...
                            temp_v0_14 = ((s32) var_fp) + (var_v0_27 >> 2);
                            sp4080 = temp_v0_14;
                        ...
                        if (sp407C != 0)
                        {
                            ...
                            temp_s6_3 = ((s32) var_fp) + (var_v0_30 >> 2);
                            rec.end_x = temp_s6_3;
