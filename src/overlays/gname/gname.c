...
GlyphInfo g_glyph_table[] = {
    {0x40, 0x88, 0x60, 0x60, 0x1},
    {0x00, 0x00, 0x40, 0xE0, 0x0},
    {0x40, 0x00, 0xC0, 0x20, 0x2},
    {0x40, 0x20, 0x40, 0x38, 0x3},
    {0x00, 0xE8, 0xE8, 0x18, 0x4},
    {0xE0, 0x20, 0x20, 0x28, 0x4},
    {0xA0, 0x48, 0x10, 0x78, 0x5},
    {0xB0, 0x48, 0x50, 0x10, 0x5},
    {0xB0, 0x58, 0x50, 0x10, 0x5},
    {0xB0, 0x68, 0x50, 0x10, 0x5},
    {0xB0, 0x78, 0x50, 0x10, 0x5},
    {0xF0, 0x88, 0x10, 0x58, 0x5},
    {0xE8, 0xE0, 0x18, 0x18, 0x5},
    {0xE8, 0xF8, 0x18, 0x08, 0x5},
    {0x80, 0x20, 0x18, 0x28, 0x2},
    {0x98, 0x20, 0x18, 0x28, 0x2},
    {0xB0, 0x20, 0x18, 0x28, 0x2},
    {0xC8, 0x20, 0x18, 0x28, 0x2},
    {0xB0, 0x90, 0x10, 0x20, 0x2},
    {0xC0, 0x90, 0x10, 0x20, 0x2},
    {0xE0, 0x90, 0x10, 0x10, 0x9},
    {0xB0, 0xB0, 0x10, 0x10, 0x6},
    {0xC0, 0xB0, 0x10, 0x10, 0x6},
    {0xD0, 0xB0, 0x10, 0x10, 0x6},
    {0xB0, 0xC0, 0x18, 0x18, 0x6},
    {0xC8, 0xC0, 0x18, 0x18, 0x6},
    {0x80, 0x48, 0x20, 0x10, 0x8},
    {0x40, 0x58, 0x20, 0x10, 0x8},
    {0x60, 0x58, 0x20, 0x10, 0x8},
    {0x80, 0x58, 0x20, 0x10, 0x8},
    {0x40, 0x68, 0x28, 0x10, 0x7},
    {0x68, 0x68, 0x28, 0x10, 0x7},
    {0x40, 0x78, 0x28, 0x10, 0x7},
    {0x68, 0x78, 0x28, 0x10, 0x7},
    {0x90, 0x68, 0x10, 0x10, 0x7},
    {0x90, 0x78, 0x10, 0x10, 0x7},
    {0xD0, 0x90, 0x10, 0x20, 0xA},
    {0xE0, 0xA0, 0x10, 0x20, 0xA},
    {0xE0, 0xC0, 0x10, 0x10, 0xA},
};
...
u32 g_kanji_entry_offsets[] = {
    0x000, 0x052, 0x09E, 0x0D2, 0x0FA, 0x158, 0x221, 0x2BD, 0x2F2,
    0x339, 0x3BE, 0x416, 0x52A, 0x556, 0x5A8, 0x5F3, 0x662, 0x69E,
    0x6D4, 0x6FA, 0x762, 0x78C, 0x7A1, 0x7A7, 0x7B3, 0x7C8, 0x832,
    0x877, 0x8BD, 0x8D6, 0x91D, 0x950, 0x970, 0x982, 0x993, 0x9B1,
    0x9D1, 0x9EF, 0xA1A, 0xA27, 0xA4D, 0xA50, 0xA65, 0xA74, 0xA8A,
};
...
u16 g_panel_record_offsets[] = {
    0x0114, 0x0116, 0x0118, 0x011C, 0x011E, 0x0120, 0x0122, 0x0124,
    0x0126, 0x0137, 0x014B, 0x015B, 0x0172, 0x018F, 0x0191, 0x0193,
    0x0195, 0x0197, 0x0199, 0x019B, 0x019D, 0x019F, 0x01A1, 0x01A3,
    ...
    0x01D5, 0x01D7, 0x01D9, 0x01DB, 0x01DD, 0x01DF, 0x01E1, 0x01E3,
    0x01E5, 0x01E7, 0x01E9, 0x01EB, 0x01ED, 0x01EF, 0x01F1, 0x01F3,
    0x01F5, 0x01F7, 0x01F9, 0x01FB, 0x01FD, 0x01FF, 0x0201, 0x0203,
    0x0205, 0x0207, 0x0209, 0x020B, 0x020D, 0x020F, 0x0211, 0x0213,
    0x0215, 0x0217, 0x0219, 0x021B, 0x021D, 0x021F, 0x0221, 0x0223,
    0x0225, 0x0227, 0x0229, 0x022B, 0x022D, 0x022F, 0x0231, 0x0233,
    0x0235, 0x0237, 0x0239, 0x023B, 0x023D, 0x023F, 0x0241, 0x0243,
    0x0245, 0x0247, 0x0249, 0x024B, 0x024D, 0x024F, 0x0251, 0x0253,
    0x0255, 0x0257, 0x0259, 0x025B, 0x025D, 0x025F, 0x0261, 0x0263,
    0x0265, 0x0267, 0x0269, 0x026B, 0x026D, 0x026F, 0x0271, 0x0273,
    0x0275, 0x0277, 0x0279, 0x027B, 0x027D, 0x027F, 0x0281, 0x0283,
    0x0285, 0x0287,
};
