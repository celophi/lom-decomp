...
extern s32 D_8011CF4C;
    ...
    wmap_draw_actor_sprite(D_800D93C8, D_8011CF4C, 0x13, 0x14, 0);
    if (--D_801B2AEC == 0)
    {
        D_801B2AE8 += 1;
    }
...
extern s32 D_8011CF4C;
    ...
    wmap_draw_actor_sprite(D_800D9344, D_8011CF4C, 0x14, 0x1F, 0);
    if (--D_801B2AF4 == 0)
    {
        D_801B2AF0 += 1;
    }
...
extern s32 D_8011CF4C;
    ...
    wmap_draw_actor_sprite(D_800D93F4, D_8011CF4C, 0x8, 0x1E, 0);
    if (--D_801B2B24 == 0)
    {
        D_801B2B20 += 1;
    }
