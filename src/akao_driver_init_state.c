    ...
    *(u16*)a1var = (a3 & 0xFFFA) | 1;
...

    {
        ...
        *((u32*)off(v0_ptr, 0x04)) = 0;
        a1var = 0x03FFF000;
        do { do { do { do { do { do { do { do { do { do { do { do { do { do { do { do { do { do { do { do { do { do { do { do { *((u32*)off(a0, 0x48)) = a1var; } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0); } while (0);
        *((u32*)off(a0, 0x4C)) = 0;
        *((u16*)off(a0, 0x5A)) = 0;
        new_var9 = v1_ptr;
