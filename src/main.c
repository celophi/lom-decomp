        ...
        do
        {
            ...
            case 1: /* switch 1 */
                ...
                *(u32*)((u8*)gameState + 0x522C) = FUN_80060814();
                ...
                if (*(u32*)((u8*)gameState + 0x522C) != 2 && *(u32*)((u8*)gameState + 0x522C) != 9 &&
                    *(u32*)((u8*)gameState + 0x522C) != 10)
                {
            ...
            case 3: /* switch 1 */
                ...
                val = temp_s2->u_608;
                D_8003EC98 = 0;
                *(u32*)(*(u8*)gameState + 0x522C) =
                    func_80140004(0x80160000, (u32)ptrA, (u32)ptrA, (val & 0x7F) + 4, 0, (u32)ptrA, 1);
                DrawSync(0);
                VSync(0);
                *(u32*)(ptrC + 3052) = 3;
                break;
