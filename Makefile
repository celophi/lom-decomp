...
OBJECTS  := $(OBJS_G0) $(OBJS_G4) $(OBJS_CDK_G0) $(OBJS_ASM)
...
overlay_checkps_gcc_srcs   := src/overlays/checkps/target.c
overlay_checkps_gnu_srcs   := src/overlays/checkps/code4.c src/overlays/checkps/code5.c src/overlays/checkps/draw.c src/overlays/checkps/code7.c src/overlays/checkps/code6.c 
...
base-objects: $(COPY_SENTINEL) $(OBJS_G0) $(OBJS_G4) $(OBJS_CDK_G0)
	@mkdir -p build/src
