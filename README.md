...
- ⚠️ **Non-matching** - every function has a C implementation, but is not yet matching the target.
- ✅ **Matching** - every function has a C implementation that matches the target byte-for-byte.
